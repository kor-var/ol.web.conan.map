...
const MapSpawns: React.FC<MapSpawnProps> = ({mapInstance, markerGroupInstance}) => {
        ...
        const addMobSpawns = (spawns: Array<SpawnMarker>) => {
            spawns.forEach((spawn) => {
                ...
                const customPopupOptions = {
                    className: 'rounded-lg bg-ol-neutralPrimary dark:bg-ol-white shadow-lg',
                };
    ...
    return (
        <>
            {/* DIALOG NPCs */}
            <SidebarItemDropDown text="Dialog NPC" id="dialognpcs-spawns-dropdown" classNameButton="rounded-lg" classNameList="rounded-lg bg-ol-neutralPrimaryAlt dark:bg-ol-neutralLighter">
                <SidebarItem text="Arcosthe Wanderer" action={() => setShowSpawns("DialogNPCDialogueArcostheWanderer")}
                    ...
                    <CheckIcon className="h-4 w-4 mr-2 text-lg text-green-800 dark:text-green-400"/>
                </SidebarItem>
            ...
            {/* ARTISANS */}
            <SidebarItemDropDown text="Artisans" id="artisans-spawns-dropdown" classNameButton="rounded-lg" classNameList="rounded-lg bg-ol-neutralPrimaryAlt dark:bg-ol-neutralLighter" >
            ...
            {/* FIGHTERS */}
            <SidebarItemDropDown text="Fighters" id="fighters-spawns-dropdown" classNameButton="rounded-lg" classNameList="rounded-lg bg-ol-neutralPrimaryAlt dark:bg-ol-neutralLighter" >
            ...
            {/* MERCHANTS */}
            <SidebarItemDropDown text="Merchants" id="merchants-spawns-dropdown" classNameButton="rounded-lg" classNameList="rounded-lg bg-ol-neutralPrimaryAlt dark:bg-ol-neutralLighter" >
            ...
            {/* WILDLIFE */}
            <SidebarItemDropDown text="Wildlife" id="wildlife-spawns-dropdown" classNameButton="rounded-lg" classNameList="rounded-lg bg-ol-neutralPrimaryAlt dark:bg-ol-neutralLighter" >
            ...
            {/* MINI BOSSES */}
            <SidebarItemDropDown text="Mini Bosses" id="minibosses-spawns-dropdown" classNameButton="rounded-lg" classNameList="rounded-lg bg-ol-neutralPrimaryAlt dark:bg-ol-neutralLighter" >
            ...
            {/* WORLD BOSSES */}
            <SidebarItemDropDown text="World Bosses" id="worldbosses-spawns-dropdown" classNameButton="rounded-lg" classNameList="rounded-lg bg-ol-neutralPrimaryAlt dark:bg-ol-neutralLighter" >
