...
export class IconsSpawns implements IIconsDictionary {
    constructor() {
        ...
        this.Lion = this.baseUrl + "/e/ec/MapMarker_petLion.png/20px-MapMarker_petLion.png";
        this.LionCub = this.baseUrl + "/e/ec/MapMarker_petLion.png/20px-MapMarker_petLion.png";
        this.Tiger = this.baseUrl + "/4/49/MapMarker_petTiger.png/20px-MapMarker_petTiger.png";
        this.TigerCub = this.baseUrl + "/4/49/MapMarker_petTiger.png/20px-MapMarker_petTiger.png";
        this.Panther = this.baseUrl + "/3/3d/MapMarker_petPanther.png/20px-MapMarker_petPanther.png";
        this.PantherCub = this.baseUrl + "/3/3d/MapMarker_petPanther.png/20px-MapMarker_petPanther.png";
        this.Wolf = this.baseUrl + "/c/c1/MapMarker_petWolf.png/20px-MapMarker_petWolf.png";
        this.WolfPup = this.baseUrl + "/c/c1/MapMarker_petWolf.png/20px-MapMarker_petWolf.png";
        this.Crocodile = this.baseUrl + "/7/72/MapMarker_petCrocodile.png/20px-MapMarker_petCrocodile.png?version=1bc258d2f5aa7ee5cc4b0a720506dd4e";
        this.DireWolf = this.baseUrl + "/3/36/MapMarker_petFrostwolf.png/20px-MapMarker_petFrostwolf.png?version=ecf2032e1d6efde45ff6512691f361cc";
        this.DireWolfPup = this.baseUrl + "/3/36/MapMarker_petFrostwolf.png/20px-MapMarker_petFrostwolf.png?version=ecf2032e1d6efde45ff6512691f361cc";
        this.Ostrich = this.baseUrl + "/c/c8/MapMarker_petOstrich.png/20px-MapMarker_petOstrich.png?version=955f959f31bec98f891e7a1599b540c1";
        this.WildBoar = this.baseUrl + "/5/56/MapMarker_petBoarShoat.png/20px-MapMarker_petBoarShoat.png";
        this.WildBoarPiglet = this.baseUrl + "/5/56/MapMarker_petBoarShoat.png/20px-MapMarker_petBoarShoat.png";
        this.Kappa = this.baseUrl + "/c/ca/MapMarker_petKappa.png/20px-MapMarker_petKappa.png";
        this.Fawn = this.baseUrl + "/5/56/MapMarker_petFawn.png/20px-MapMarker_petFawn.png";
        this.StripedHyena = this.baseUrl + "/c/cf/MapMarker_petStripedHyena.png/20px-MapMarker_petStripedHyena.png";
        this.StripedHyenaPuppy = this.baseUrl + "/c/cf/MapMarker_petStripedHyena.png/20px-MapMarker_petStripedHyena.png";
        this.SpottedHyena = this.baseUrl + "/3/34/MapMarker_petSpottedHyena.png/20px-MapMarker_petSpottedHyena.png";
        this.SpottedHyenaPuppy = this.baseUrl + "/3/34/MapMarker_petSpottedHyena.png/20px-MapMarker_petSpottedHyena.png";
        this.Sabretooth = this.baseUrl + "/a/a8/MapMarker_petSabretooth.png/20px-MapMarker_petSabretooth.png";
        this.SabretoothCub = this.baseUrl + "/a/a8/MapMarker_petSabretooth.png/20px-MapMarker_petSabretooth.png";
        this.Jaguar = this.baseUrl + "/3/33/MapMarker_petJaguar.png/20px-MapMarker_petJaguar.png";
        this.JaguarCub = this.baseUrl + "/3/33/MapMarker_petJaguar.png/20px-MapMarker_petJaguar.png";
        this.Rhino = this.baseUrl + "/5/5f/MapMarker_petRhino.png/20px-MapMarker_petRhino.png";
        this.Elephant = this.baseUrl + "/5/53/MapMarker_petElephant.png/20px-MapMarker_petElephant.png";
        this.BrownBear = this.baseUrl + "/6/62/MapMarker_petBrownBear.png/20px-MapMarker_petBrownBear.png";
        this.BlackBearCub = this.baseUrl + "/0/08/MapMarker_pet.png/20px-MapMarker_pet.png";
        this.Hyena = this.baseUrl + "/0/08/MapMarker_pet.png/20px-MapMarker_pet.png";
        this.HyenaPuppy = this.baseUrl + "/0/08/MapMarker_pet.png/20px-MapMarker_pet.png";
    }
    [key: string]: string;
}
